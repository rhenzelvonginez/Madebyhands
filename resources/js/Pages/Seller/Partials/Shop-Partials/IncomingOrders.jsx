...
export default function IncomingOrders({ incomingOrdersData }) {
    ...
    const submitProcessItem = (e, id) => {
        e.preventDefault();
        patch(route("seller.order.process", { id }));
    };
                ...
                {incomingOrdersData.length == 0 ? (
                    ...
                    incomingOrdersData.map((item) => (
                        ...
                        >
                            ...
                            <button
                                disabled={processing}
                                onClick={(e) => submitProcessItem(e, item.id)}
                                className="w-full bg-blue-600 duration-200 ease-in-out hover:bg-blue-700 text-white p-2 rounded-lg"
                            >
                                {processing
                                    ? " Processing Order..."
                                    : " Process Order"}
