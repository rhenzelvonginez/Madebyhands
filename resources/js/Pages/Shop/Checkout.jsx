...
export default function Checkout({ auth }) {
    const { products, flash, currentAddress } = usePage().props;
    ...
    const totalSf = products?.reduce(
        (acc, item) => acc + parseInt(item.product_sf),
        0
    );
    ...
    return (
        <UserAuthenticatedLayout user={auth.user}>
            ...
            <div className="mx-auto">
                <div className="md:min-w-[40rem] p-6 my-6 bg-white border border-gray-200 shadow-lg md:rounded-lg">
                    ...
                    <form onSubmit={handleSubmit} className="mt-6" method="POST">
                        <div className="p-4 bg-gray-100 rounded-lg">
                            ...
                            <div className="text-gray-600">{currentAddress}</div>
                        </div>
                        ...
                        <div className="flex justify-between mt-2 font-semibold text-gray-700">
                            ...
                            <span>
                                Php
                                {" " + new Intl.NumberFormat().format(totalSf)}
                            </span>
                        </div>
                        <div className="flex justify-between mt-2 font-semibold text-gray-700">
